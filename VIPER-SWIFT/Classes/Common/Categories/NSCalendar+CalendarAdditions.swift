...
extension NSCalendar {
    ...
    func daysRemainingInWeekWithDate(date: NSDate) -> Int {
        let weekdayComponent = components(NSCalendarUnit.CalendarUnitWeekOfMonth, fromDate: date)
        let daysRange = rangeOfUnit(NSCalendarUnit.CalendarUnitWeekOfMonth, inUnit: NSCalendarUnit.CalendarUnitWeekOfMonth, forDate: date)
    ...
    func isDate(date: NSDate, duringSameWeekAsDate: NSDate) -> Bool {
        let dateComponents = components(NSCalendarUnit.CalendarUnitWeekOfMonth, fromDate: date)
        let duringSameWeekComponents = components(NSCalendarUnit.CalendarUnitWeekOfMonth, fromDate: duringSameWeekAsDate)
    ...
    func isDate(date: NSDate, duringWeekAfterDate: NSDate) -> Bool {
        ...
        let dateComponents = components(NSCalendarUnit.CalendarUnitWeekdayOrdinal, fromDate: date)
        let nextWeekComponents = components(NSCalendarUnit.CalendarUnitWeekOfMonth, fromDate: nextWeek)
